...
from heart_stroke.constant import SCHEMA_FILE_PATH
from heart_stroke.entity.config_entity import StrokePredictionConfig
...
class HeartStrokeClassifier:
    def __init__(self, prediction_pipeline_config: StrokePredictionConfig = StrokePredictionConfig(),) -> None:
        """
    ...
    def predict(self, dataframe) -> str:
        ...
        """
        try:
            logging.info(f"Entered predict method of HeartStrokeClassifier class")
            model = StrokeEstimator(
                bucket_name = self.prediction_pipeline_config.model_bucket_name,
                model_path=self.prediction_pipeline_config.model_file_path,
            )
            heart_op = model.predict(dataframe)
