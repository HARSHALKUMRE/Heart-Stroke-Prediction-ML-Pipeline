...
class ModelTrainerConfig:
    model_trainer_artifact: str = os.path.join(training_pipeline_config.artifact_dir, MODEL_TRAINER_DIR_NAME)
    trained_model_file_path: str = os.path.join(model_trainer_artifact, MODEL_TRAINER_TRAINED_MODEL_DIR, MODEL_FILE_NAME)
